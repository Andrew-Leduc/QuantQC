...
nPOP_obj_Exp <- DIANN_to_nPOP(params$data_path,params$linker_path, plex = 2, carrier = T)
...
nPOP_obj_Exp <- cellXpeptide(nPOP_obj_Exp, params$ChQ)
...
PlotNegCtrl(nPOP_obj_Exp)


nPOP_obj_Exp <- FilterBadCells(nPOP_obj_Exp, min_pep = 700)
...
PlotCellSizeVsIntensity(nPOP_obj_Exp, type = 'Run order')
