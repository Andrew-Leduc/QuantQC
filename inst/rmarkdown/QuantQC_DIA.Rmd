...
QQC_obj_Exp <- DIANN_to_QQC(params$data_path,params$linker_path, plex = 2, carrier = T)
...
nPOP_obj_Exp <- EvaluateNegativeControls(QQC_obj_Exp)


PlotNegCtrl(QQC_obj_Exp)


QQC_obj_Exp <- FilterBadCells(QQC_obj_Exp, min_intense = 6)
...
nPOP_obj_Exp <- ComputeUMAP(QQC_obj_Exp)
