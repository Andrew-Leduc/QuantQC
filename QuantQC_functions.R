...
## Packages (User needs to install them before hand)
library(BiocManager)
library(seqinr)
library(psych)
library(dplyr)
...
### Report Generation
Gen_QQC_report_from_list <- function(config_list){
  render('~/Desktop/Current_projects/QQC_pub/QuantQC_DDA.Rmd')
  output_file = paste0(state, '.html')
}

Gen_QQC_report_from_obj <- function(nPOP_obj){
  render('~/Desktop/Current_projects/QQC_pub/QuantQC_DDA.Rmd')
  output_file = paste0(state, '.html')
}
...
analyzeCellenONE_TMT <- function(allDays){
  ...
  #file_paths
  labelPath <- '/Users/andrewleduc/Desktop/Current_projects/QQC_pub/14plex_files/Labels.fld'
  pickupPath1 <- '/Users/andrewleduc/Desktop/Current_projects/QQC_pub/14plex_files/Pickup_mock.fld'
...
analyzeCellenONE_mTRAQ <- function(allDays,plex){
  ...
  if(plex == 2){
    ...
    # 2plex
    labelPath <- '/Users/andrewleduc/Desktop/Current_projects/Quant_QC/2plex_files/Labels.fld'
    pickupPath1 <- '/Users/andrewleduc/Desktop/Current_projects/Quant_QC/2plex_files/Pickup_1_mock.fld'
    pickupPath2 <- '/Users/andrewleduc/Desktop/Current_projects/Quant_QC/2plex_files/Pickup_2_mock.fld'
    
  }
  if(plex == 3){
    
    # 3plex
    labelPath <- '3plex_files/Labels.fld'
    #labelPath <- '/Users/andrewleduc/Library/CloudStorage/GoogleDrive-leduc.an@husky.neu.edu/.shortcut-targets-by-id/1uQ4exoKlaZAGnOG1iCJPzYN3ooYYZB7g/MS/Users/LK/Slice_Vadim/Labels.fld'
    
    pickupPath1 <- '3plex_files/Pickup_mock_1.fld'
    #pickupPath1 <- '/Users/andrewleduc/Library/CloudStorage/GoogleDrive-leduc.an@husky.neu.edu/.shortcut-targets-by-id/1uQ4exoKlaZAGnOG1iCJPzYN3ooYYZB7g/MS/Users/aleduc/CellenONE/Pickup_mock_1_DONT_USE.txt'
    pickupPath2 <- '3plex_files/Pickup_mock_2.fld'
    #pickupPath2 <- '/Users/andrewleduc/Library/CloudStorage/GoogleDrive-leduc.an@husky.neu.edu/.shortcut-targets-by-id/1uQ4exoKlaZAGnOG1iCJPzYN3ooYYZB7g/MS/Users/aleduc/CellenONE/Pickup_mock_2_DONT_USE.txt'
