...
# Creating nPOP object

The first step of the workflow is to read in the raw data and generate our nPOP object. 
...
Trachea <- MQ_to_nPOP(data_path,link_path,PIF = .75, PEP = .07)


  # DIA

# Trachea <- DIANN_to_nPOP(data_path,linker_path, plex = 2, carrier = T)
